...
class UpdateContactResult1: Codable {
    let success: Bool
    let message: String
...
extension DataRequest {
    ...
    @discardableResult
    func responseUpdateContactResult(queue: DispatchQueue? = nil, completionHandler: @escaping (DataResponse<UpdateContactResult1>) -> Void) -> Self {
